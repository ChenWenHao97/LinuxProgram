...
int main(int argc,char * argv[])
{
    ...
    ret = bind(listenfd,(struct scoketaddr*)&address,sizeof(address));
    assert(ret!=-1);
    ...
    ret = bind(udpfd,(struct socketaddr*)&address,sizeof(address));
    assert(ret!=-1);
    ...
    while(true)
    {
        ...
        for(int i = 0;i < number;i++)
        {
            ...
            else if(sockfd == udpfd)
            {
                ...
                bzero(buf,sizeof(int)*UDP_BUFFER_SIZE);
            ...
            else if(events[i].events & EPOLLIN)
            {
                ...
                while(1)
                {
                    bzero(buf,sizeof(int)*TCP_BUFFER_SIZE);
                ...
                cout <<"somthing else happend"<<endl;
        }
    }
